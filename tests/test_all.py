...
class Init(TestCase):
    ...
    def test_exports__unique(self):
        ...
        exports = argmatch.__all__
        export_set = set(exports)
        repeats = [name for name in export_set if countOf(exports, name) > 1]
        self.assertListEqual(
            repeats,
            list(),
            msg="argmatch.__all__ contains repeated entries: %s" % repeats,
        )
    ...
    def test_exports__only_available(self):
        ...
        """
        missing = set(n for n in argmatch.__all__ if getattr(argmatch, n, None) is None)
        self.assertSetEqual(
            missing,
            set(),
            msg="argmatch.__all__ contains unresolved names: %s" % missing,
        )
    ...
    def test_exports__only_exported_by_submodules(self):
        ...
        exported_by_root = set(argmatch.__all__)

        private_exports = exported_by_root - exported_by_submodules
        self.assertSetEqual(
            private_exports,
            set(),
            msg="argmatch.__all__ has private symbols: %s" % private_exports,
        )
    ...
    def test_exports__all_of_submodule_exports(self):
        ...
        self.assertSetEqual(
            ...
            "from argmatch.__all__: %s" % missing_exports,
        )
    ...
    def get_submodules(self):
        ...
        for name, obj in vars(argmatch).items():

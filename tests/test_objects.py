...
import argmatch.objects as __unit__
...
class Bytes(MatcherTestCase):
    ...
    test_empty_unicode = lambda self: self.assert_no_match("")
    test_some_unicode = lambda self: self.assert_no_match("Alice has a cat")
...
class Coroutine(MatcherTestCase):
    ...
    def assert_match(self, value):
        return super(Coroutine, self).assert_match(__unit__.Coroutine(), value)

    def assert_no_match(self, value):
        return super(Coroutine, self).assert_no_match(__unit__.Coroutine(), value)
...
class FileLike(MatcherTestCase):
    ...
    def assert_match(self, value, *args, **kwargs):
        return super(FileLike, self).assert_match(
            __unit__.FileLike(*args, **kwargs), value
        )

    def assert_no_match(self, value, *args, **kwargs):
        return super(FileLike, self).assert_no_match(
            __unit__.FileLike(*args, **kwargs), value
        )

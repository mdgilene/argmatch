...
import argmatch.strings as __unit__
...
class Unicode(MatcherTestCase):
    test_none = lambda self: self.assert_no_match(None)
    test_empty_unicode = lambda self: self.assert_match("")
    test_some_unicode = lambda self: self.assert_match("Alice has a cat")
...
class StartsWith(MatcherTestCase):
    ...
    def assert_match(self, value, prefix):
        return super(StartsWith, self).assert_match(__unit__.StartsWith(prefix), value)

    def assert_no_match(self, value, prefix):
        return super(StartsWith, self).assert_no_match(
            __unit__.StartsWith(prefix), value
        )
...
class EndsWith(MatcherTestCase):
    ...
    def assert_match(self, value, suffix):
        return super(EndsWith, self).assert_match(__unit__.EndsWith(suffix), value)

    def assert_no_match(self, value, suffix):
        return super(EndsWith, self).assert_no_match(__unit__.EndsWith(suffix), value)
...
class Glob(PatternTestCase):
    ...
    def test_system_case(self):
        ...
        self.assertIs(fnmatch.fnmatch, __unit__.Glob("", case="system").fnmatch)
    ...
    def assert_match(self, value, pattern, case=__unit__.Glob.DEFAULT_CASE):
        return super(Glob, self).assert_match(__unit__.Glob(pattern, case), value)

    def assert_no_match(self, value, pattern, case=__unit__.Glob.DEFAULT_CASE):
        return super(Glob, self).assert_no_match(__unit__.Glob(pattern, case), value)
...
class Regex(PatternTestCase):
    ...
    def assert_no_match(self, value, pattern):
        return super(Regex, self).assert_no_match(__unit__.Regex(pattern), value)

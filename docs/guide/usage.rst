...
that the expected mocks interactions had happened, *argmatch* can help quite a bit.
...
Using **argument matchers** provided by *argmatch*, you can express this intent clearly and concisely:

.. code-block:: python

    from argmatch import GreaterThan, Integer
...
You can use all *argmatch* matchers any time you are asserting on calls received by ``Mock``, ``MagicMock``,
...
Individual matchers, such as :class:`String <argmatch.strings.String>` or :class:`Float <argmatch.numbers.Float>`,
...
have a look at the wide array of existing matchers offerred by *argmatch*:

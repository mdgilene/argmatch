# -*- coding: utf-8 -*-
#
# argmatch documentation build configuration file, created by
...
project = "argmatch"
copyright = "%s, Karol Kuczmarski" % date.today().year
...
version = re.search(r"\d+\.\d+", argmatch.__version__).group()
# The full version, including alpha/beta/rc tags.
release = argmatch.__version__
...
html_theme_options = {
    ...
    "description": argmatch.__description__,
    "github_user": "Xion",
    "github_repo": "argmatch",
    "github_type": "star",
    "github_count": False,
...
man_pages = [(master_doc, "argmatch", "argmatch Documentation", [author], 1)]
...
autoclass_content_exceptions = [
    "argmatch.operators.Contains",
    "argmatch.operators.In",
]
...
def autodoc_process_docstring(app, what, name, obj, options, lines):
    ...
    """
    # check that only symbols that can be directly imported from ``argmatch``
    # package are being documented
    _, symbol = name.rsplit(".", 1)
    if symbol not in argmatch.__all__:
        raise SphinxError("autodoc'd '%s' is not a part of the public API!" % name)
